...
class tdg_managerController extends Controller
{
    ...
    public function addProject(Request $request)
    {
        if ($request->isMethod("GET")) {
            $obj = 'No project';
            return view('tdg_manager.addproject', compact('obj'));
            ...
            $status = '<div id="ProjectHascreated" class="alert alert-success   show m-0 mt-2 mb-2 p-2" role="alert">
            ...
            return redirect()->route('tdg-manager.addProject')->with(['obj' => $obj])->with('status', $status);
        }
    }
